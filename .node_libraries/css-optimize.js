 ...
 */
function _extractDataUrls(css, preservedTokens) {
 ...
 * @returns String The processed css
 */
function _compressHexColors(css) {
...
function cssOptimize(css, options) {
    ...
    options = options || {};
    var mode = isNaN(options.mode) ? 1 : options.mode, linebreakpos = options.linebreakpos;

    if (!css) return css;

    if (linebreakpos === undefined) {
        linebreakpos = -1;
    }
